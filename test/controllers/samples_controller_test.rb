...
class SamplesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sample" do
    assert_difference('Sample.count') do
      post samples_url, params: { sample: { name: @sample.name, outcrop_uuid: @sample.outcrop_uuid, uui: @sample.uui } }
    end
  ...
  test "should update sample" do
    patch sample_url(@sample), params: { sample: { name: @sample.name, outcrop_uuid: @sample.outcrop_uuid, uui: @sample.uui } }
